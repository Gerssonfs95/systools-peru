...
const functionalTools = new Set(["calculadora-margen-ganancia"]);
...
export default async function ToolPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return <section className="container-page max-w-5xl py-14 md:py-20">
    ...
    {functionalTools.has(slug) ? <ProfitMarginCalculator /> : <div className="card grid min-h-72 place-items-center p-8 text-center"><div><span className="mx-auto grid size-16 place-items-center rounded-2xl bg-[#16a8ff]/10 text-[#62d6ff]"><Clock3 size={30} /></span><h2 className="mt-6 text-2xl font-black">Herramienta próximamente</h2><p className="mx-auto mt-3 max-w-lg leading-7 text-[#91a0b5]">Estamos preparando esta herramienta para que sea clara, rápida y útil. Muy pronto estará disponible.</p></div></div>}
  </section>;
}
